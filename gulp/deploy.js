...
gulp.task('configs', function(){
    ...
    var result = gulp.src(['app/config_system.json', 'app/local/config.json'])
        .pipe(plugins.jsonminify())           // remove comments in json files
        .pipe(plugins.extend('config_system.json', true, 4));
...
gulp.task('fonts', function () {
    ...
    var localFonts = gulp.src(['app/fonts/**/*.{eot,svg,ttf,woff,woff2}', 'app/bower_components/grommet-branding-assets/icons/font/fonts/*']);
